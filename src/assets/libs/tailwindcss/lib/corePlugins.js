...
let variantPlugins = {
  ...
  hasVariants: ({ matchVariant }) => {
    ...
    matchVariant(
      ...
      (value, { modifier }) =>
        modifier
          ? `:merge(.group\\/${modifier}):has(${(0, _dataTypes.normalize)(value)}) &`
          : `:merge(.group):has(${(0, _dataTypes.normalize)(value)}) &`,
      {
        values: {},
      }
    )
    matchVariant(
      ...
      (value, { modifier }) =>
        modifier
          ? `:merge(.peer\\/${modifier}):has(${(0, _dataTypes.normalize)(value)}) ~ &`
          : `:merge(.peer):has(${(0, _dataTypes.normalize)(value)}) ~ &`,
      {
        values: {},
      }
    )
  ...
  ariaVariants: ({ matchVariant, theme }) => {
    ...
    matchVariant(
      ...
      (value, { modifier }) =>
        modifier
          ? `:merge(.group\\/${modifier})[aria-${(0, _dataTypes.normalize)(value)}] &`
          : `:merge(.group)[aria-${(0, _dataTypes.normalize)(value)}] &`,
      {
    ...
    matchVariant(
      ...
      (value, { modifier }) =>
        modifier
          ? `:merge(.peer\\/${modifier})[aria-${(0, _dataTypes.normalize)(value)}] ~ &`
          : `:merge(.peer)[aria-${(0, _dataTypes.normalize)(value)}] ~ &`,
      {
  ...
  dataVariants: ({ matchVariant, theme }) => {
    ...
    matchVariant(
      ...
      (value, { modifier }) =>
        modifier
          ? `:merge(.group\\/${modifier})[data-${(0, _dataTypes.normalize)(value)}] &`
          : `:merge(.group)[data-${(0, _dataTypes.normalize)(value)}] &`,
      {
    ...
    matchVariant(
      ...
      (value, { modifier }) =>
        modifier
          ? `:merge(.peer\\/${modifier})[data-${(0, _dataTypes.normalize)(value)}] ~ &`
          : `:merge(.peer)[data-${(0, _dataTypes.normalize)(value)}] ~ &`,
      {
