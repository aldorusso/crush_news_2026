...
const DecoRoomSetup = () => {
  ...
  return (
    <Layout5>
      <BreadCrumb title="DECO & ROOM SETUP" titleType="Aesthetic Life" />
                ...
                <div className="block lg:flex gap-4">
                  ...
                  <div className="py-4 lg:py-0 lg:w-1/2">
                    <h3 className="text-lg sm:text-xl mb-4 hover:text-[#ff3750] dark:text-white dark:hover:text-[#ff3750]">
                      <Link to="/single-post">Crea tu espacio ideal y aesthetic</Link>
                    </h3>
                    ...
                    <p className="text-gray-400 text-sm sm:text-base mb-2 dark:text-gray-300">
                      Ideas de decoración para tu habitación y setup
                    </p>
                  </div>
                </div>
              </div>
...
export const Head = () => <Seo title="Deco & Room Setup - Aesthetic Life" />
export default DecoRoomSetup
