...
const EvolucionEstilo = () => {
  ...
  return (
    <Layout5>
      <BreadCrumb title="EVOLUCIÓN DE ESTILO" titleType="Crush Files" />
                ...
                <div className="block lg:flex gap-4">
                  ...
                  <div className="py-4 lg:py-0 lg:w-1/2">
                    <h3 className="text-lg sm:text-xl mb-4 hover:text-[#ff3750] dark:text-white dark:hover:text-[#ff3750]">
                      <Link to="/single-post">Cómo ha cambiado el estilo de tus ídolos favoritos</Link>
                    </h3>
                    ...
                    <p className="text-gray-400 text-sm sm:text-base mb-2 dark:text-gray-300">
                      Análisis de las transformaciones de estilo a través del tiempo
                    </p>
                  </div>
                </div>
              </div>
