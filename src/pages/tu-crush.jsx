...
const TuCrush = () => {
  ...
  return (
    <Layout5>
      <BreadCrumb title="TU CRUSH" titleType="Love Lab" />
                ...
                <div className="block lg:flex gap-4">
                  ...
                  <div className="py-4 lg:py-0 lg:w-1/2">
                    <h3 className="text-lg sm:text-xl mb-4 hover:text-[#ff3750] dark:text-white dark:hover:text-[#ff3750]">
                      <Link to="/single-post">Todo sobre tus crushes y cómo conquistarlos</Link>
                    </h3>
                    ...
                    <p className="text-gray-400 text-sm sm:text-base mb-2 dark:text-gray-300">
                      Consejos y tips para acercarte a esa persona especial
                    </p>
                  </div>
                </div>
              </div>
